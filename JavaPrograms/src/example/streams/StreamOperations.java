...
public class StreamOperations {
	...
	public void reduce(List<Book> books) {
		System.out.println("\nReduce ...");
		books.stream()
	...
	public void reduceImperatively(List<Book> books) {
	...
	public void find(List<Book> books) {
		System.out.println("\nFinding ...");
	...
	public void match(List<Book> books) {
		System.out.println("\nMatching Method... ");
	...
	// DB world: select distinct (ISBN) from book where rating >= 4.5 limit 0, 5;
	 public void slice(List<Book> books) {
		System.out.println("\nInside Stream:\n Slice Method ... ");
